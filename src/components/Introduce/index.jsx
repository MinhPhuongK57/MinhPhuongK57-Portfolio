                ...
                <div id='popup-article' className='popup'>
                    <div className='popup__block'>
                        ...
                        <p className='popup__description'>
                            ...
                            , introducing myself and my abilities in the information technology industry.
                            <br />
                            <br />
                            You can see my CV in the{' '}
                            <a href='/MinhPhuongK57-Portfolio/#cv'>
                                <strong title='Curriculum Vitae'>Resume</strong>
                            </a>{' '}
