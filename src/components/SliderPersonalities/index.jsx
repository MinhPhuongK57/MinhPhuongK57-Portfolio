        ...
        return slidePersonalities.map((item, index) => {
            return (
                ...
                >
                    ...
                    <p className='slider__txt wow animate__fadeInUp' data-wow-duration='0.3s' data-wow-delay='0.25s'>
                        {item.description}
                    </p>
                </div>
            );
    ...
    return (
        <section className='container'>
            ...
            <div className='slider'>
                <input type='radio' name='slider' title='slider1' className='slider__nav' defaultChecked />
                <input type='radio' name='slider' title='slider2' className='slider__nav' />
                <input type='radio' name='slider' title='slider3' className='slider__nav' />
                <input type='radio' name='slider' title='slider4' className='slider__nav' />
