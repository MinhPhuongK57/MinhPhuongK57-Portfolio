        ...
        <div className="login">
            ...
            <form className="login__form">
                <div className="login__form--content">
                    <input type="text" placeholder=" " name="name" id="name" className="form-input" autoComplete="Off"/>
                    <label className="form-label">Name</label>
                </div>
                <div className="login__form--content">
                    <input type="email" placeholder=" " name="email" id="email" className="form-input" autoComplete="Off"/>
                    <label className="form-label">Email</label>
                </div>
                <div className="login__form--content">
                    <input type="password" placeholder=" " name="password" id="password" className="form-input" autoComplete="Off"/>
