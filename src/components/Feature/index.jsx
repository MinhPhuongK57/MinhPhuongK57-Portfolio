...
function Feature() {
            ...
            return (
                <div key={index} className='grid__page--items'>
                    <img
                        ...
                        data-wow-delay='0.2s'
                    />
                    <div className='grid-content wow animate__backInUp' data-wow-duration='0.3s' data-wow-delay='0.2s'>
                        {quote.description}
                    </div>
    ...
    return (
        <section className='con_pad grid' id='feature'>
            <h2 className='grid--title wow animate__fadeInUp' data-wow-duration='0.3s' data-wow-delay='0.2s'>
