...
function Product() {
    const RenderProduct = () => {
        return listProducts.map((product, index) => {
            return (
                <div className={product.className} key={index} data-wow-duration='0.4s' data-wow-delay='0.2s'>
                    <div className='product--image'>
                        <img className='product--image-border' src={product.image} alt={product.imageAlt} />
                    </div>
                    <div className='product__text'>
                        ...
                        <span className='product__text--groupButton'>
                            ...
                            {product.private && (
                                <a
                                    href='#products'
                                    className='product__text--button product__text--buttonPri'
                                    rel='noreferrer'
                                    title='Private'
                                    aria-disabled
                                >
    ...
    return (
        <section className='container con_pad' id='product'>
            <div className='product'>
                <h2 className='product--title wow animate__fadeInUp' data-wow-duration='0.3s' data-wow-delay='0.2s'>
                    Products
                </h2>
